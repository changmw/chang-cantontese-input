...
Define class MyPage4 as MyPage
	...
	* BackColor=RGB(199,157,83)
	...
	Add Object lblFreeware As Label With ;
		...
		Caption="Freeware and open source (2004-2018)", ForeColor=rgb(128,64,0)
...
Define class MyLblContainer as Container
	...
	Add Object lblChangjei As MyLabel With ;
		...
		ForeColor=RGB(0,255,255), FontBold=.t., ToolTipText="­Ü¾e½X Click to copy"
...
Define class MyPage1 as MyPage
	...
	* Add Object edit1 As MyUnicodeEdit
	...
	with this.parent
		...
		if type("m.aa")="N"
			if m.aa<>0
				.cntLabels.lblCalculate.caption="M = "+LTRIM(floatpnt(m.aa,15,4))
			endif
		else
