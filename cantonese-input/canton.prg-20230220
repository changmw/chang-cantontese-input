...
Define class cntPage3C2 as container
	...
	* update data
	...
	Add Object cmdUpdate as MyCommandButton with ;
		top=80, left=140, caption="\<Add", visible=.f.
		...
		with thisform.PageFrame1.Page1.Edit1
			...
			DO case
				...
				CASE "hkcd.com/"$m.xx
					...
					m.zz=dbcs2uncd("-香港商報")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=STRCONV("4oCU",14)+dbcs2uncd("香港商報")
					m.xx=STRTRAN(m.xx,m.zz,"")
				...
				CASE "hket.com/"$m.xx
					...
					** not perfectly working, pending date
					m.zz=dbcs2uncd("- 香港經濟日報 - TOPick - 新聞 - 社會 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 即時新聞頻道 - 國際形勢 - 環球政治 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 中國頻道 - 國情動向 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 中國頻道 - 社會熱點 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 即時新聞頻道 - 即市財經 - 股市 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 趨勢 - 趨勢分析 - 財金 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 香港經濟日報 - 即時新聞頻道 - 科技 - D")
					m.xx=STRTRAN(m.xx,m.zz,"")
					* trailing text in line 2 of CopyTitleURL
					m.ii=RAT("/",m.xx)
					m.zz=SUBSTR(m.xx,m.ii+1)
				...
				CASE "mingpao.com/"$m.xx
					...
					* not perfectly working, date
					m.zz=dbcs2uncd("- 熱點 - 即時新聞 - 明報新聞網")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 港聞 - 即時新聞 - 明報新聞網")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 國際 - 即時新聞 - 明報新聞網")
					m.xx=STRTRAN(m.xx,m.zz,"")
					m.zz=dbcs2uncd("- 兩岸 - 即時新聞 - 明報新聞網")
					m.xx=STRTRAN(m.xx,m.zz,"")
					* trailing text in line 2 of CopyTitleURL
					m.ii=RAT("/",m.xx)
					m.zz=SUBSTR(m.xx,m.ii+1)
